...
void processChunk(uint8_t chunk[64], uint32_t hi[]){
...
void processChunks(uint8_t *bits, uint8_t len, uint8_t hash[32]){
...
void hash(const uint8_t *bits, const uint8_t *length, uint8_t *result) {

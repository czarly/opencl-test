...
inline void sha512_128(__global const uint8_t* msg, uint64_t* ctx)
{
    int i;
...
inline void sha512_128_local(const uint8_t* msg, uint64_t* ctx)
{
    int i;
    /* for each chunk create a 80-entry message schedule array w[0..79] of 64-bit words */
    uint64_t w[80];
...
__kernel void sha512_hash(__global const uint8_t *bits, __global const size_t *length, __global const uint8_t *target, __local uint8_t *hash, __global int *results){
    ...
    sha512_calc(bits + (x*item_length), item_length, h);
